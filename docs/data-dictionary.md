...
- **Code Reference**: [useCeoData.ts](../src/components/CeoView/useCeoData.ts#L153-L168)
...
- **Code Reference**: [useCeoData.ts](../src/components/CeoView/useCeoData.ts#L170-L175)
...
- **Code Reference**: [useCeoData.ts](../src/components/CeoView/useCeoData.ts#L180-L195)
...
- **Code Reference**: [useSalesDirectorData.ts](../src/components/SalesDirectorView/useSalesDirectorData.ts#L140-L160)
...
- **Code Reference**: [useSalesDirectorData.ts](../src/components/SalesDirectorView/useSalesDirectorData.ts#L185-L200)
...
- **Code Reference**: [useBrandDashboard.ts](../src/components/BrandDashboardView/useBrandDashboard.ts#L245-L276)
...
- **Code Reference**: [SupplyChainView.tsx](../src/components/SupplyChainView.tsx#L85-L105)

### Gross Operating Margin
- **Formula**: $\text{Net Revenue} - (\text{COGS} \times \text{MarginModifier})$
- **Source Fields**: `Revenue`, `adminSettings.marginModifier`
- **Code Reference**: [FinancialPlanningView.tsx](../src/components/FinancialPlanningView.tsx#L120-L135)
